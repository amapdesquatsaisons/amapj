...
public class MesLivraisonsService
{
	...
	private List<EGPlanningMensuel> computePlanningMensuel(EntityManager em, Date dateDebut, Date dateFin,List<RoleList> roles)
	{
		List<EGPlanningMensuel> res = new ArrayList<EGPlanningMensuel>(); 
