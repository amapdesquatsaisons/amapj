 ...
 * 
 */
 package fr.amapj.service.services.excelgenerator.producteur;
...
import fr.amapj.service.services.excelgenerator.EGAvoirs;
...
public class EGPaiementProducteur extends AbstractExcelGenerator
{
	...
	/**
	 * La ligne avoir est présente uniquement si il y a réellement
	 * des avoirs
	 * @param et
	 * @param mntAvoir
	 */
