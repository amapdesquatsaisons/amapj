 ...
 * 
 */
 package fr.amapj.service.services.pdfgenerator;
...
import fr.amapj.service.services.velocity.VCBuilder;
 ...
 * 
 */
public class PGEngagement extends AbstractOdtGenerator
{
	
	Long modeleContratId;
	
	public PGEngagement(Long modeleContratId)
	{
	...
	public void fillWordFile(EntityManager em,OdtGeneratorTool et)
	{
		...
		EditionSpecifique editionSpecifique = mc.getProducteur().getEngagement();
