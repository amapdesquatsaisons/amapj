...
public class VCContrat
{
	...
	public String getTableauCheque()
	{
		return tableauCheque;
	}

	public void setTableauCheque(String tableauCheque)
	{
		this.tableauCheque = tableauCheque;
	}
