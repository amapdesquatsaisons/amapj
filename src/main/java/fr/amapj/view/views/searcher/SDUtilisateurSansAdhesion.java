...
public class SDUtilisateurSansAdhesion implements SearcherDefinition
{
	@Override
	...
	{
		Long idPeriodeCotisation = (Long) params;
		return  new GestionCotisationService().getAllUtilisateurSansAdhesion(idPeriodeCotisation);
	}
