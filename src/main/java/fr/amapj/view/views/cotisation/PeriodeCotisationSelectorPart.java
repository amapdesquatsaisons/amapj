...
public class PeriodeCotisationSelectorPart
{
	...
	private void constructMultiplePeriode(HorizontalLayout toolbar1)
	{
		...
		periodeCotisationBox.setSizeUndefined();
		periodeCotisationBox.addStyleName(ChameleonTheme.LABEL_BIG);
		
		periodeCotisationBox.addValueChangeListener(new Property.ValueChangeListener()
		{
