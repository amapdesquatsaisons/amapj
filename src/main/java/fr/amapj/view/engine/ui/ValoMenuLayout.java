...
public class ValoMenuLayout extends HorizontalLayout
{
	...
	public static void setFrontOffice()
	{
		...
		((AmapUI) UI.getCurrent()).getRoot().contentArea.removeStyleName("back-office-backgroundimage");
		((AmapUI) UI.getCurrent()).getRoot().contentArea.removeStyleName("back-office-long-backgroundimage");
	}
	

	public static void setBackOffice()
	{
		((AmapUI) UI.getCurrent()).getRoot().contentArea.addStyleName("back-office-backgroundimage");
