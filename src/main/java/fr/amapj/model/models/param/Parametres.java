...
public class Parametres implements Identifiable
{
	...
	/**
	 * Activation ou désactivation du module "Edition spécifique"
	 */
	@NotNull
	@Enumerated(EnumType.STRING)
    private EtatModule etatEditionSpecifique;
	...
	public EtatModule getEtatEditionSpecifique()
	{
		return etatEditionSpecifique;
	}


	public void setEtatEditionSpecifique(EtatModule etatEditionSpecifique)
	{
		this.etatEditionSpecifique = etatEditionSpecifique;
	}
